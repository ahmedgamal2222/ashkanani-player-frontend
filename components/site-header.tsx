    ...
    >
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-3 py-2 sm:h-18 sm:gap-4 sm:px-6 sm:py-3 lg:px-8">
        ...
        <a href="#home" className="group flex min-w-0 items-center gap-2.5 sm:gap-3">
          <AgencyLogo size="xs" className="h-7 sm:h-11" />
          <span className="grid size-8 shrink-0 place-items-center overflow-hidden rounded-full border border-primary/40 bg-white/5 transition-transform duration-500 group-hover:scale-105 sm:size-11">
